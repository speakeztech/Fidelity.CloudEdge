...
type workers_binding_item =
    ...
    | Ratelimit of workersbindingkindratelimit
    ...
    | Vpcservice of workersbindingkindvpcservice
...
type MetadataValue =
    ...
    static member Create (id: string): MetadataValue =
        { account = None
          cloudService = None
          coldStart = None
          cost = None
...
type ``workers-observabilitytelemetryevent`` =
    ...
    static member Create (``$metadata``: MetadataValue,
                          dataset: string,
                          source: Newtonsoft.Json.Linq.JToken,
...
type ``workersapi-response-null-result`` =
    { errors: Option<list<``workersapi-response-null-resultErrors``>>
      messages: Option<list<``workersapi-response-null-resultMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
      result: Option<Newtonsoft.Json.Linq.JObject> }
    ...
    static member Create (): ``workersapi-response-null-result`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersdomain-response-collection`` =
    { errors: Option<list<``workersdomain-response-collectionErrors``>>
      messages: Option<list<``workersdomain-response-collectionMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
    ...
    static member Create (): ``workersdomain-response-collection`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersdomain-response-single`` =
    { errors: Option<list<``workersdomain-response-singleErrors``>>
      messages: Option<list<``workersdomain-response-singleMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
    ...
    static member Create (): ``workersdomain-response-single`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersscript-response-collection`` =
    { errors: Option<list<``workersscript-response-collectionErrors``>>
      messages: Option<list<``workersscript-response-collectionMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
    ...
    static member Create (): ``workersscript-response-collection`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersscript-response-single`` =
    { errors: Option<list<``workersscript-response-singleErrors``>>
      messages: Option<list<``workersscript-response-singleMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
    ...
    static member Create (): ``workersscript-response-single`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersusage-model-response`` =
    { errors: Option<list<``workersusage-model-responseErrors``>>
      messages: Option<list<``workersusage-model-responseMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
      result: Option<``workersusage-model-responseResult``> }
    ...
    static member Create (): ``workersusage-model-response`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersversions-list-response`` =
    { errors: Option<list<``workersversions-list-responseErrors``>>
      messages: Option<list<``workersversions-list-responseMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
      result: Option<``workersversions-list-responseResult``> }
    ...
    static member Create (): ``workersversions-list-response`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersversions-single-response`` =
    { errors: Option<list<``workersversions-single-responseErrors``>>
      messages: Option<list<``workersversions-single-responseMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
      result: Option<Newtonsoft.Json.Linq.JToken> }
    ...
    static member Create (): ``workersversions-single-response`` =
        { errors = None
          messages = None
          success = None
          result = None }
...
type ``workersversions-upload-response`` =
    { errors: Option<list<``workersversions-upload-responseErrors``>>
      messages: Option<list<``workersversions-upload-responseMessages``>>
      ///Whether the API call was successful.
      success: Option<bool>
      result: Option<Newtonsoft.Json.Linq.JToken> }
    ...
    static member Create (): ``workersversions-upload-response`` =
        { errors = None
          messages = None
          success = None
          result = None }
